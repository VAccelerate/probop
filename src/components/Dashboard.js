  ...
  render () {
    return (
      <div>
        ...
        <SafeModal toggle={this.toggle} modal={this.state.modal} content={this.state.modalContent} vulnerableContacts={this.state.vulnerableContacts} dangerContacts={this.state.dangerContacts} safeMessage={this.state.safeMessage} />
      </div>
    )
  }
}
